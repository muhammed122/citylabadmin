...
public class OfferViewModel extends ViewModel {
    ...
    public void addOffer(MultipartBody.Part image, String title, String desc, String startDate, String  endDate,
        ...
        Log.d("dddddddddddddddddd", "addOffer:"+startDate);



        retrofitService.uploadOffer(image, title, desc, "11/12/2013", endDate, oldPrice, newPrice)
                .subscribeOn(Schedulers.io())
                .subscribeOn(AndroidSchedulers.mainThread())
                .subscribe(new SingleObserver<AddOfferResponse>() {
                    @Override
                    ...
                    @Override
                    public void onSuccess(@NonNull AddOfferResponse offerResponse) {
